-- ============================================================
-- MODEL   : base_instacart_order_products_prior
-- LAYER   : Bronze
-- SOURCE  : instacart_bronze.base_instacart_order_products_prior (ClickHouse — loaded from CSV)
-- TRANSFORMS:
...
with source as (
    select * from {{ source('instacart_bronze', 'base_instacart_order_products_prior') }}
),
